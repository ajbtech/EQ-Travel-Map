...
## Polish
- [X] Fix bevel so it matches the original UI style
- [X] Fix button style to match the original EverQuest UI
- [X] Fix overall sizing in the input window
